...
public class EnemySpawner : MonoBehaviour
{
    ...
    private List<Enemy> _spawnedAliveEnemies = new List<Enemy>();
    ...
    private void OnEnemyDeath(Enemy deathEnemy, int point)
    {
    ...
    {
        EnemyWaveSO wave = _enemyWaves[_currentWaveIndex];
        ...
        //Get enemy prefab
        Enemy enemyPrefab = wave.EnemiesItems[selectedIndex].EnemyPrefab;
    ...
    IEnumerator SpawnEnemyWithDelay(Enemy enemyPrefab, Vector3 spawnPoint)
    {
        _pendingEnemiesToSpawn++;
        
        //TODO: Add indicator object to indicate where it's gonna spawn
        yield return new WaitForSeconds(1);
        Enemy newEnemy = Instantiate(enemyPrefab, spawnPoint, Quaternion.Euler(0, Random.value * 360, 0));
