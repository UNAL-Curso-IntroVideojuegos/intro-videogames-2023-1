...
public class PlayerTankMovement : MonoBehaviour
{
    ...
    public global::System.Single Speed { get => _speed; set => _speed = value; }
    public global::System.Single TurnSpeed { get => _turnSpeed; set => _turnSpeed = value; }
    public Transform Cannon { get => Cannon1; set => Cannon1 = value; }
    public Transform Cannon1 { get => _cannon; set => _cannon = value; }
    ...
    {
        _rb.rotation = Mathf.LerpAngle(_rb.rotation, _rotAngle, TurnSpeed * Mathf.Deg2Rad * Time.fixedDeltaTime);
        _rb.velocity = transform.up * Speed * _inputMagnitude;
    }
}